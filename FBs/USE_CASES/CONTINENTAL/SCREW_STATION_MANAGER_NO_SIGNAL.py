...
class SCREW_STATION_MANAGER_NO_SIGNAL:    
    def __init__(self):
        self.station_id = 0
        self.ok = 0
        self.nok = 0
    ...
    def schedule(self, event_name, event_value, START_STATION_BIT,STATION_ID, PART_ID, NUMBER_OF_SCREWS,SIGNAL_SCREW_NOK_BIT, END_STATION_BIT):
