...
class TINA_1:
    ...
    def schedule(self, event_name, event_value, material_name, container_name, fault_prob):
        ...
        if event_name == 'INIT':
            ...
            # Productive waiting for CSE
            elif self.actual_state == 2:
                # waits 10 seconds
                #sleep(0.5)

                # runs in productive loop - No error
                return [None, None, None, None, None, None,
                        None, None,
                        self.states_sequence[self.actual_state]]
        ...
        # standby
            ...
            return [None, 1, None, None, None, None,
                    None, None,
                    self.states_sequence[self.actual_state]]
            #return [None, event_value, None, None, None,self.material_name, self.container_name,self.states_sequence[self.actual_state]]
